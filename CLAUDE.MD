...
├── supermarkets.json        # Albert Heijn product database (16,173 products)
├── favorites.json           # User's favorite recipes
├── common-products.json     # Frequently used products cache (for faster lookups)
